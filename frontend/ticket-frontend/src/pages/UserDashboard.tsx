                ...
                <div style={{ borderTop: "1px solid #e5e7eb", paddingTop: "16px" }}>
                  {[
                    ...
                    const answers = [
                      ...
                      "Oui la modification est possible uniquement tant que le ticket est en attente et non assigné. Une fois le traitement commencé, la modification n'est plus autorisée.",
