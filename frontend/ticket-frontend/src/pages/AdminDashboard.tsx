  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Inter', system-ui, sans-serif", background: "#f5f5f5", overflowX: "visible" }}>
      ...
      <div 
        ...
        {userRole === "Admin" && (
          <div 
            onClick={() => changeSectionForAdmin("users")}
            style={{ 
              display: "flex", 
              alignItems: "center", 
              gap: "12px", 
        ...
        {userRole === "Admin" && (
          <div 
            onClick={() => changeSectionForAdmin("groupes")}
            style={{ 
              display: "flex", 
              alignItems: "center", 
              gap: "12px", 
        ...
        {userRole === "Admin" && (
          <div 
            onClick={() => changeSectionForAdmin("roles")}
            style={{ 
              display: "flex", 
              alignItems: "center", 
              gap: "12px", 
        ...
        <div 
          onClick={() => changeSectionForAdmin("departements")}
          style={{ 
            display: "flex", 
            alignItems: "center", 
            gap: "12px", 
        ...
        {userRole === "Admin" && (
          <div 
            onClick={() => changeSectionForAdmin("maintenance")}
            style={{ 
              display: "flex", 
              alignItems: "center", 
              gap: "12px", 
        ...
        {userRole === "Admin" && (
          <div 
            onClick={() => changeSectionForAdmin("audit-logs")}
            style={{ 
              display: "flex", 
              alignItems: "center", 
              gap: "12px", 
          ...
          <div>
            ...
            {showSettingsDropdown && (
              <div style={{ 
                ...
                <div
                  onClick={() => changeSectionForAdmin("apparence")}
                  style={{
                    padding: "8px 12px",
                    cursor: "pointer",
                    color: "white",
                ...
                <div
                  onClick={() => changeSectionForAdmin("email")}
                  style={{
                    padding: "8px 12px",
                    cursor: "pointer",
                    color: "white",
                ...
                <div
                  onClick={() => changeSectionForAdmin("securite")}
                  style={{
                    padding: "8px 12px",
                    cursor: "pointer",
                    color: "white",
        ...
        <div style={{ marginTop: "auto", flexShrink: 0 }}>
          ...
          <div
            onClick={() => changeSectionForAdmin("notifications")}
            style={{
              display: "flex",
              alignItems: "center",
              gap: "10px",
        ...
        {activeSection === "actifs" && (
          ...
          {activeSection === "tickets" && (
            <div style={{ display: showTicketDetailsPage ? "none" : "block" }}>
              <TicketsSection
                showTicketsPlaceholder={!ticketsSectionReady}
                ...
                onExportExcel={() => {
                  try {
                    ...
                    XLSX.writeFile(wb, `Tickets_Admin_${new Date().toISOString().split("T")[0]}.xlsx`);
                  } catch (error) {
                ...
                onExportPdf={() => {
                  try {
                    const doc = new jsPDF();
                    doc.setFontSize(14);
                    doc.text("Liste des tickets (Admin)", 14, 20);
                    doc.setFontSize(10);
                    ...
                    doc.save(`Tickets_Admin_${new Date().toISOString().split("T")[0]}.pdf`);
                  } catch (error) {
